...
JIG_EX_Chopper_Type	= 	["RHS_CH_47F_light"];		// Desired Evac Chopper classname in quotes and array.// WIP Testing to Support: "B_Heli_Transport_01_camo_F"	"CH49_Mohawk_FG"
